...
<span class="imprimir">
	<h4>Consulta interna de solicitação de serviço</h4>
</span>
			...
			<tr>
				...
				<td>Nenhum</td>
					<script>
						...
						return confirm("Você tem certeza que quer se vincular a essa solicitação?");
				...
				?>
				<td><a onclick='return confirmLink()' href="?folder=solicitations/&file=linkperson_solicitations&ext=php&id=<?php echo $sel_solicitations_data['id'];?>"><img src="../layout/images/link_person.png" height="30px"></a></td>
				...
				?>
					<script>
						function confirmUnlink(){
							...
							return confirm("Você tem certeza que quer se desvincular a essa solicitação?");

						}
					</script>
				<td><a onclick='return confirmUnlink()' href="?folder=solicitations/&file=unlinkperson_solicitations&ext=php&id=<?php echo $sel_solicitations_data['id'];?>"><img src="../layout/images/unlink_person.png" height="20px"></a></td>
				<td><a href="?folder=solicitations/&file=fmend_solicitations&ext=php&id=<?php echo $sel_solicitations_data['id'];?>"><img src="../layout/images/check.png" height="30px"></a></td>
